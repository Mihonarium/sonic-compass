    ...
    <LinearGradient colors={['#0f1a2b', '#253b56']} style={styles.container}>
      ...
      <View style={styles.gridContainer}>
        <TouchableOpacity
          ...
          onPress={() => { Haptics.selectionAsync(); setShowDropdown(true); }}
        >
          <Text style={styles.gridLabel}>Frequency</Text>
          <Text style={styles.gridValue}>{freqTxt()}</Text>
          <Text style={styles.gridDesc}>Cue interval</Text>
        </TouchableOpacity>
        ...
        >
          ...
          <Text style={styles.gridDesc}>Announce early</Text>
        </TouchableOpacity>

        <TouchableOpacity
          style={[styles.gridItem, vibrationMode && styles.gridItemActive]}
          onPress={() => { Haptics.selectionAsync(); setVibrationMode(!vibrationMode); }}
        >
      ...
      <TouchableOpacity
        style={styles.advancedHintDown}
        onPress={scrollToAdvanced}
      >
        <Text style={styles.advancedHintText}>Advanced ↓</Text>
      </TouchableOpacity>
        </View>

        <View style={[styles.page, { height: screenHeight }]}>
          <TouchableOpacity
            style={styles.advancedHintUp}
            onPress={scrollToMain}
          >
            <Text style={styles.advancedHintText}>↑ Back</Text>
          </TouchableOpacity>
